...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- <?php var_dump($comic) ?> -->
                    <!-- <?php var_dump($detailGenre) ?> -->
                    <?php echo form_open_multipart('admin/comic_edit/' . $comic['id_komik'], ['id' => 'formComic']); ?>
                    <div class="row my-3">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-5 ">
                                            <label for="image" class="frame" id="frameImage">
                                                <?php if (isset($comic['imageUrl'])) : ?>
                                                    <img src="<?= base_url() ?>assets/images/comic/<?= $comic['imageUrl'] ?>" width="100%" height="100%" style="border-radius: 5px;">
                                                <?php else : ?>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="judul" aria-describedby="emailHelp" name="judul" value="<?= $comic['judul'] ?>">
                                                <?= form_error('judul', '<small class="text-danger">', '</small>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="jenis">Jenis Komik</label>
                                                <input type="text" class="form-control" id="jenis" aria-describedby="emailHelp" value="<?= $comic['jenis'] ?>" name="jenis">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status" name="status">
                                                    <?php foreach ($status as $stat) : ?>
                                                        <option value="<?= $stat['id_status'] ?>" <?= $stat['id_status'] == $comic['status'] ? 'selected' : '' ?>><?= $stat['nama_status'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="is_active" name="is_active" value="<?= $comic['is_active'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="genre" name="genre[]" required multiple>
                                            <?php foreach ($genres as $genre) : ?>
                                                <option value="<?= $genre['id_genre'] ?>" <?php foreach ($detailGenre as $select) : ?> <?= $select['id_genre'] == $genre['id_genre'] ? 'selected' : '' ?> <?php endforeach; ?>><?= $genre['nama_genre'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        ...
        let dataActive = `<?= $comic['is_active'] ?>`
        if (dataActive == `1`) {
            isActive.setAttribute('checked', 'true');
            isActive.classList.add('checked');
            labelActive.innerHTML = "Active";
        } else {
            isActive.classList.remove('checked');
            labelActive.innerHTML = "Tidak Active";
        }
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formComic').on('click', '.close-img', function(e) {
                e.preventDefault();
                $('#frameImage').html(
                    `<img src="https://source.unsplash.com/random/800x600" width="100%" height="100%" style="border-radius: 5px;">`
                );
